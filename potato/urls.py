...
from potato.views import home_view,PostDetailView,post_user,like_json,login_view,get_post,post_create,UserUpdateView
...
urlpatterns = [
    ...
    url(r'^user/(?P<pk>\d+)$', UserUpdateView.as_view(), name='user-update'),
